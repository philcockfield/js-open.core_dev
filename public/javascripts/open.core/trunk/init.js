...
// This file was autogenerated by public/javascripts/closure/2011_04_06/closure-library/closure/bin/build/depswriter.py.
// Please do not edit.
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/button/button.model.js', ['core.controls.button.Model'], ['core.models.Control']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/button/button.view.js', ['core.controls.button.View'], ['core.controls.button.Model', 'core.mvc.View']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/button/button_types/default_button.view.js', ['core.controls.button.defaultButton.View'], ['core.controls.button.View', 'core.css', 'lib.jquery', 'lib.jqueryUI']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/button/button_types/text_button.view.js', ['core.controls.button.textButton.View'], ['core.controls.button.View', 'lib.jquery']);
...
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/json/json.page.js', [], ['core.controls.json.Model', 'core.controls.json.View']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/json/json.tmpl.js', ['core.controls.json.tmpl'], ['soy', 'soy.StringBuilder']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/controls/json/json.view.js', ['core.controls.json.View'], ['core.controls.json.Model', 'core.mvc.View']);
...
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/models/spacing.js', ['core.models.Spacing'], ['core.mvc.Model']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/mvc/model.js', ['core.mvc.Model'], ['core.global', 'core.util.func', 'lib.backbone']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/mvc/view.js', ['core.mvc.View'], ['core.global', 'lib.backbone', 'lib.jquery']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/testing/backbone_mock_ajax.js', ['core.testing.backbone'], ['lib.backbone', 'lib.jasmine.mock.ajax']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/testing/testing.util.js', ['core.testing.util'], ['goog.string', 'lib.underscore']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/util/css.js', ['core.css'], ['goog.global', 'lib.jquery']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/util/events.js', ['core.events'], ['lib.jquery']);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/util/func.js', ['core.util.func'], []);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/util/mobile.js', ['core.util.mobile'], []);
goog.addDependency('{open.core}/javascripts/open.core/trunk/code/util/reflection.js', ['core.reflection'], []);
...
goog.addDependency('{open.core}/javascripts/open.core/trunk/lib/jquery/ui/jquery-ui-1.8.11.custom.min.js', ['lib.jqueryUI'], []);
